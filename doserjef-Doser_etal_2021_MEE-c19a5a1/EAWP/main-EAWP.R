...
out.model.A.C <- jags(bugs.data.A.C, inits, params.A.C, './doserjef-Doser_etal_2021_MEE-c19a5a1/EAWP/model-AC-eawp-jags.txt',
 	              n.iter = n.iter, n.thin = n.thin, n.burn = n.burn,
 	              n.chain = n.chain, n.adapt = n.adapt, parallel = TRUE)
out.model.C <- jags(bugs.data.C, inits, params.C, './doserjef-Doser_etal_2021_MEE-c19a5a1/EAWP/model-C-eawp-jags.txt',
 		    n.iter = n.iter, n.thin = n.thin, n.burn = n.burn,
 		    n.chain = n.chain, n.adapt = n.adapt, parallel = TRUE)
out.model.A.V.C <- jags(bugs.data.A.V.C, inits, params.A.V.C, './doserjef-Doser_etal_2021_MEE-c19a5a1/EAWP/model-AVC-eawp-jags.txt',
 			n.iter = n.iter, n.thin = n.thin, n.burn = n.burn,
 			n.chain = n.chain, n.adapt = n.adapt, parallel = TRUE)
out.model.A <- jags(bugs.data.A, inits, params.A, './doserjef-Doser_etal_2021_MEE-c19a5a1/EAWP/model-AV-eawp-jags.txt',
 		    n.iter = n.iter, n.thin = n.thin, n.burn = n.burn,
  		    n.chain = n.chain, n.adapt = n.adapt, parallel = TRUE)

save(out.model.A, out.model.C, out.model.A.C, out.model.A.V.C, file = './doserjef-Doser_etal_2021_MEE-c19a5a1/EAWP/eawp-results.R')
...
pdf('./doserjef-Doser_etal_2021_MEE-c19a5a1/EAWP/eawp-summary-plot.pdf', width = 14)
